...
@section('content_header')
    <h1 class="animate-slide-in">Edit Data Buku</h1>
@stop
...
<div class="card shadow-lg animate-fade-in" style="border-radius:10px;overflow:hidden;">
    ...
    <div class="card-body">
        <form action="{{ route('books.update', $book->id) }}" method="POST" enctype="multipart/form-data" class="animate-fade-in">
            @csrf
            @method('PUT')
            ...
            <div class="form-group">
                ...
                <input type="text" name="title"
                       class="form-control input-animated @error('title') is-invalid @enderror"
                       value="{{ old('title', $book->title) }}" placeholder="Masukkan judul" required>
            ...
            <div class="form-group">
                ...
                <select name="category_id"
                        class="form-control input-animated @error('category_id') is-invalid @enderror" required>
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" name="author"
                           class="form-control input-animated @error('author') is-invalid @enderror"
                           value="{{ old('author', $book->author) }}" placeholder="Nama pengarang">
                    @error('author') <div class="invalid-feedback">{{ $message }}</div> @enderror
                </div>
                <div class="form-group col-md-6">
                    <label class="font-weight-500">Penerbit</label>
                    <input type="text" name="publisher"
                           class="form-control input-animated @error('publisher') is-invalid @enderror"
            ...
            <div class="form-row">
                <div class="form-group col-md-4">
                    ...
                    <input type="number" name="year"
                           class="form-control input-animated @error('year') is-invalid @enderror"
                           value="{{ old('year', $book->year) }}" placeholder="YYYY">
                    @error('year') <div class="invalid-feedback">{{ $message }}</div> @enderror
                </div>
                <div class="form-group col-md-8">
                    <label class="font-weight-500">Cover Buku (Max 1MB)</label>
                    <input type="file" name="cover"
                           class="form-control input-animated @error('cover') is-invalid @enderror"
                           accept="image/*">
            ...
            <div class="form-group">
                ...
                <textarea name="description" rows="3"
                          class="form-control input-animated @error('description') is-invalid @enderror"
            ...
            <div class="form-group">
                ...
                <select name="stock"
                        class="form-control input-animated @error('stock') is-invalid @enderror" required>
...
/* File input */
input[type="file"].input-animated{padding:8px 14px;line-height:1.2;overflow:hidden;position:relative}
...
input[type="file"].input-animated::file-selector-button{
    ...
    background:#192334;color:#fff;cursor:pointer;transition:.3s
}
input[type="file"].input-animated::-webkit-file-upload-button:hover,
input[type="file"].input-animated::file-selector-button:hover{background:#87C15A}
